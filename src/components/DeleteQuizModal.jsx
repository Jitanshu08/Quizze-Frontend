        ...
        {step === 1 ? (
          <>
            ...
            <div className="create-quiz-form-group">
              <label className="create-quiz-label">Quiz Name:</label>
              <input
                type="text"
                value={quizName}
            ...
            <div className="create-quiz-form-group">
              <label className="create-quiz-label">Quiz Type:</label>
              <div>
                <label>
                  <input
                    type="radio"
            ...
            <div className="create-quiz-modal-actions">
              <button className="create-quiz-button" onClick={handleCancel}>
                Cancel
              </button>
              <button className="create-quiz-button" onClick={handleContinue}>
                Continue
              </button>
            </div>
          </>
              ...
              <>
                ...
                <div className="create-quiz-question-group">
                  ...
                  {questions[activeQuestionIndex].options.map(
                    (option, oIndex) => (
                      <div key={oIndex} className="create-quiz-option-group">
                        <input
                          type="text"
                          value={option}
                          onChange={(e) =>
                        ...
                        {questions[activeQuestionIndex].options.length > 2 && (
                          <button
                            ...
                            className="create-quiz-remove-button"
                          >
                            Remove
                          </button>
                        )}
                  ...
                  <div className="create-quiz-form-group">
                    <label className="create-quiz-label">Timer:</label>
                    <select
